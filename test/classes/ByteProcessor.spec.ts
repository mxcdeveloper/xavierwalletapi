...
describe('ByteProcessor', () => {
    ...
    beforeEach(() => {
        ...
        Base58 = Xavier.byteProcessors.Base58;
        Bool = Xavier.byteProcessors.Bool;
        Byte = Xavier.byteProcessors.Byte;
        Long = Xavier.byteProcessors.Long;
        StringWithLength = Xavier.byteProcessors.StringWithLength;
